      ...
      <div className="flex flex-col items-center justify-center gap-8">
        <div className="flex items-center justify-center gap-8 md:gap-12">
          <img
            ...
            className="w-8 h-8 md:w-14 md:h-14 object-cover rounded-full hover:md:w-15 hover:cursor-pointer hover:md:h-15 hover:ring-4 hover:ring-primary hover:p-1 hover:bg-white"
          />
          <img
            src="https://img.freepik.com/foto-gratis/hombre-barbudo-feliz-sorprendido-camisa-apuntando-lejos_171337-5021.jpg"
            className="w-10 h-10 md:w-16 md:h-16 object-cover rounded-full hover:md:w-15 hover:cursor-pointer hover:md:h-15 hover:ring-4 hover:ring-primary hover:p-1 hover:bg-white"
          />
          <img
