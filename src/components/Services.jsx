  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4">
        ...
        <form className="w-full">
          <div className="relative">
            ...
            <button
              type="submit"
              className="absolute text-white hover:scale-105 easy-out duration-150 font-semibold py-2 px-6 bg-primary  rounded-xl top-1/2 -translate-y-1/2 right-2"
            >
              Suscribe
            </button>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="flex flex-col gap-2 hover:drop-shadow-md">
